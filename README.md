...
Plataforma para consultar informações confiáveis sobre suplementos alimentares — sem precisar criar conta.

## Para que serve

Suplementos como whey protein, creatina e vitaminas são vendidos em grande quantidade, mas nem sempre é fácil saber o que cada produto realmente contém, para que serve, se está regularizado perante a Anvisa e se as alegações da embalagem são permitidas por lei. O Suplemento Consciente reúne essas informações em um só lugar, de forma simples e acessível a qualquer pessoa.
...
- **Vídeos curtos** sobre suplementos, usos e cuidados
- **Quiz** para testar o que você sabe sobre o assunto, com ranking dos melhores resultados
